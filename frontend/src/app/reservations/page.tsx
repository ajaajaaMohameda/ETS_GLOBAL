...
export default function ReservationsPage() {
  ...
  if (isLoading && !data) {
    return <div className="flex justify-center items-center h-64">Chargement de vos réservations...</div>;
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Link href="/sessions" className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 text-sm font-medium transition-colors">
      ...
      {data?.data.length === 0 ? (
        <div className="bg-white rounded-lg shadow-sm p-8 text-center border border-gray-200">
          <p className="text-gray-500 mb-4">Vous n'avez aucune réservation pour le moment.</p>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {data?.data.map((reservation) => (
            <div key={reservation.id} className="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200 flex flex-col">
              <div className="p-5 flex-grow">
                ...
                <p className="text-gray-900 font-medium mb-2">{formatDate(reservation.session.startsAt)}</p>
                <p className="text-gray-500 text-sm mb-4">{reservation.session.location}</p>
              ...
              <div className="bg-gray-50 px-5 py-3 border-t border-gray-200">
                <button
                  ...
                  className="w-full flex justify-center items-center px-4 py-2 border border-red-300 text-sm font-medium rounded-md shadow-sm text-red-700 bg-white hover:bg-red-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
